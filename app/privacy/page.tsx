        ...
        <div className="space-y-8 text-sm sm:text-base text-gray-300 leading-relaxed border-t border-white/10 pt-8">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-400">
              ...
              <li><strong className="text-white">Data Deletion Request:</strong> You retain complete control over your data. You can permanently delete your ToViral AI account, disconnect your TikTok profile, and erase all associated metrics and access tokens at any time by clicking your <strong className="text-white">Delete Account & All Data</strong> button under the dashboard/ inside the read zone.</li>
